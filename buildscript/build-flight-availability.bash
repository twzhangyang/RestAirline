...
docker build --build-arg Version=$LABEL -f ./src/FlightAvailability/RestAirline.FlightAvailability.Api/Dockerfile ./src --tag $REPOSITORY:$VERSION --tag $REPOSITORY:latest
